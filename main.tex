...
\newcommand{\hlgreen}[1]{{\sethlcolor{white}\hl{#1}}}
...
\thesistitle{Analysis of robot Navigation Among Movable Obstacles in unknown environments and extension to social and dynamic constraints} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
