...
\thesistitle{First steps toward integrating social and dynamic concerns in the domain of\\Navigation Among Movable Obstacles} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
