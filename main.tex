...
\thesistitle{Extending locally optimal robot\\Navigation Among Movable Obstacles\\in unknown environments with social and dynamic constraints} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Fabrice \textsc{Jumel}\\
			Jacques \textsc{Saraydaryan}\\
			Olivier \textsc{Simonin}\\} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
